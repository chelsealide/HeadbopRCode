...
### 1. Experiment 1, First Response (Log Regression)
### 2. Experiment 2, First Response (Log Regression)
### 3. Experiment 2, Exploration Patterns (Regression)
### 4. Experiment 2, Engagement Duration (Regression)
### 5. Experiment 2, IBA Duration (Regression)



# 1). Experiment 1 /// First Response \\\ Logistic Regression ---- 
...
# 2). Experiment 2 /// First Response \\\ Logistic Regression ----
...
# 3). Experiment 2 /// Exploration Patterns (Head & Hand Touches) \\\ Regression ----
